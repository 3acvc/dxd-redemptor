...
export type GetUniswapV3PoolDataByTokensAtBlockQueryVariables = Exact<{
...
export type GetUniswapV3PoolDataByTokensAtBlockQuery = { __typename?: 'Query', pools: Array<{ __typename?: 'Pool', id: string, token0Price: any, token1Price: any, feeTier: any, token0: { __typename?: 'Token', decimals: any, symbol: string, address: string }, token1: { __typename?: 'Token', decimals: any, symbol: string, address: string } }> };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    getUniswapV3PoolDataByTokensAtBlock(variables: GetUniswapV3PoolDataByTokensAtBlockQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetUniswapV3PoolDataByTokensAtBlockQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetUniswapV3PoolDataByTokensAtBlockQuery>(GetUniswapV3PoolDataByTokensAtBlockDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getUniswapV3PoolDataByTokensAtBlock', 'query');
    }
  };
}
